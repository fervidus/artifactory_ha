...
class artifactory_ha(
  ...
  String $yum_name                                                        = 'bintray-jfrog-artifactory-ha-rpms',
  String $yum_baseurl                                                     = 'http://jfrog.bintray.com/artifactory-ha-rpms',
  String $package_name                                                    = 'jfrog-artifactory-ha',
